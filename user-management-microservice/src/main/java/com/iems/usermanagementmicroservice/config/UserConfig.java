...
public class UserConfig {
    ...
    CommandLineRunner commandLineRunner(UserRepository userRepository) {
        return args -> {
            UserModel user01 = new UserModel("Alex", "Pasca", "alex@yahoo.com", passwordEncoder.encode("12345678"), LocalDate.of(2002, Month.JUNE, 20), Role.USER);
            UserModel user02 = new UserModel("Oana", "Morar", "oana@yahoo.com", passwordEncoder.encode("12345678"), LocalDate.of(2001, Month.MARCH, 26), Role.USER);
            UserModel user03 = new UserModel("Mihai", "Mic", "mihai@yahoo.com", passwordEncoder.encode("12345678"), LocalDate.of(1998, Month.FEBRUARY, 18), Role.USER);
